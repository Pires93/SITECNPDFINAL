            ...
            <div class="container">
              ...
              <div class="col-md-2">
                <Field
                  ...
                  name="tipoPessoaSR"
                  value="Pessoa Singular"
                  v-model="tipoPtipoPessoaSRessoa"
                />
                <label for="Pessoa Singular"> Pessoa Singular</label>
              </div>
              <div class="col-md-2">
              ...
              <div class="col-md-12">
                <Field
                  ...
                  id="nomeDenominacaoSR"
                   placeholder=" Nome/Denominação"
                />
                <ErrorMessage class="errorMessage" name="nomeDenominacaoSR" />
              </div>
              ...
              <div class="col">
                <Field
                  ...
                  placeholder="Número de NIF"
                />
                <ErrorMessage class="errorMessage" name="nifRespSR" />
              </div>
              <div class="col-md-12">
                <div class="row">
                  <div class="col">
                  ...
                  <div class="col">
                    <Field
                      ...
                      placeholder="Cidade/Vila/Lugar/Zona"
                    />
                    <ErrorMessage class="errorMessage" name="localRespSR" />
                  </div>
                </div>
              </div>
              <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <Field
                      ...
                      placeholder="Contato: Telefone/Telemovel"
                    />
                    <ErrorMessage class="errorMessage" name="telefoneRespSR" />
                  </div>
                </div>
              </div>
              <div class="col-md-12">
                <div class="row">
                  <div class="col">
                    <Field
                      ...
                      placeholder="Entre o seu email: example@cnpd.cv"
                    />
                    <ErrorMessage class="errorMessage" name="emailRespSR" />
                  </div>
                  <div class="col">
                    <div class="col">
                      <Field
                    ...
                    <ErrorMessage class="errorMessage" name="paisRespSR" />
                  </div>
                </div>
              </div>
                <div class="col-md-12" id="divloco">
              ...
              <div class="col-md-12">
                <Field
                  ...
                  placeholder=" Representante"
                    />
                    <ErrorMessage class="errorMessage" name="representanteSR" /> 
              </div>
              <div class="col">
                <Field 
                      type="text"
              ...
              <div class="col-md-12" id="divloco">
                <div class="col-md-12">
                  <div class="row">
                    <div class="col">
                      ...
                      id="localMoradaRepSR"
                        placeholder="Cidade/Vila/Lugar/Zona"
                    />
                    <ErrorMessage class="errorMessage" name="localMoradaRepSR" />  
                    </div>
                    <div class="col">
                      <input
                        disabled
                  ...
                  <Field
                    ...
                    placeholder="Nome da pessoa de contato"
                    />
                    <ErrorMessage class="errorMessage" name="nomePessoaContatoSR" />   
                </div>
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      id="emailMoradaRepSR"
                        placeholder="Entre o email da pessoa de contato: example@cnpd.cv"
                    />
                    <ErrorMessage class="errorMessage" name="emailMoradaRepSR" />  
                    </div>
                    <div class="col">
                      <Field
                      :rules="validateNumber"
                      ...
                      id="telefoneMorRepSR"
                        placeholder="Contato: Telefone/Telemovel"
                    />
                    <ErrorMessage class="errorMessage" name="telefoneMorRepSR" />   
                    </div>
                  </div>
                </div>
                </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <ErrorMessage class="errorMessage" name="outraFormaDireitoAcesso" /> 
              </div>
            </div>
          </div>
        </div>
